import { networks, Network } from 'sberjs-wallet';
...
export default class NetworkController extends IController {
  public static NETWORKS: QryNetwork[] = [
    new QryNetwork(NETWORK_NAMES.MAINNET, networks.mainnet, 'https://explorer.sbercoin.com/tx'),
    // new QryNetwork(NETWORK_NAMES.TESTNET, networks.testnet, 'https://testnet.sbercoin.com/tx'),
