  ...
  public render() {
    ...
    return info && (
      <div className={classes.root}>
        ...
        { /*<Typography className={classes.balanceUSD}>{`${sberBalanceUSD} ${networkBalAnnotation}`}</Typography> */ }
        <div className={classes.actionButtonsContainer}>
          <Button
            ...
            >
              {chrome.i18n.getMessage('popup_components_accountInfo_send')}
            </Button>
          <Button
            id="receiveButton"
            color="secondary"
            ...
            >
              {chrome.i18n.getMessage('popup_components_accountInfo_receive')}
            </Button>
        </div>
      </div>
    );
