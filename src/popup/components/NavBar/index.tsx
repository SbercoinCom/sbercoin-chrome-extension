...
const SettingsButton: React.SFC<IProps> =
  ...
  <Fragment>
    ...
    >
      <MenuItem onClick={navBarStore.routeToSettings}>{chrome.i18n.getMessage('popup_components_navbar_settings')}</MenuItem>
      <MenuItem onClick={navBarStore.logout}>{chrome.i18n.getMessage('popup_components_navbar_logout')}</MenuItem>
    </Menu>
  </Fragment>
));
