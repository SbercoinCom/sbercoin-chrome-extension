  ...
  public render() {
    ...
    return(
      <div className={classes.root}>
        <NavBar hasBackButton title={chrome.i18n.getMessage('popup_pages_settings_settings')} />
...
const SliField: React.SFC<any> = observer(({ classes, store: { settingsStore } }: any) => (
  <div className={classes.fieldContainer}>
    <Heading name={chrome.i18n.getMessage('popup_pages_settings_sessionLogoutInterval')} />
