  ...
  public render() {
    ...
    return (
      <div className={classes.root}>
        <NavBar hasBackButton title={chrome.i18n.getMessage('popup_pages_send_send')} />
...
const FromField = observer(({ classes, store: { sendStore, sessionStore } }: any) => (
  <div className={classes.fieldContainer}>
    <Heading name={chrome.i18n.getMessage('popup_pages_send_from')} />
...
const ToField = observer(({ classes, store: { sendStore, sessionStore }, onEnterPress }: any) => (
  <div className={classes.fieldContainer}>
    <Heading name={chrome.i18n.getMessage('popup_pages_send_to')} />
    <div className={classes.fieldContentContainer}>
      <TextField
        className={classes.selectOrTextField}
        fullWidth
...
const TokenField = observer(({ classes, store: { sendStore } }: any) => (
  <div className={classes.fieldContainer}>
    <Heading name={chrome.i18n.getMessage('popup_pages_send_token')} />
    <div className={classes.fieldContentContainer}>
      <Select
        className={classes.selectOrTextField}
        disableUnderline
  ...
  <div className={classes.fieldContainer}>
    <div className={classes.buttonFieldHeadingContainer}>
      <div className={classes.buttonFieldHeadingTextContainer}>
        <Heading name={chrome.i18n.getMessage('popup_pages_send_amount')} />
      </div>
      ...
      >
        {chrome.i18n.getMessage('popup_pages_send_max')}
      </Button>
    </div>
    <div className={classes.fieldContentContainer}>
      <TextField
...
const TransactionSpeedField = observer(({ classes, store: { sendStore } }: any) => (
  <div className={classes.fieldContainer}>
    <Heading name={chrome.i18n.getMessage('popup_pages_send_txSpeed')} />
    <div className={classes.fieldContentContainer}>
      <Select
        className={classes.selectOrTextField}
        disableUnderline
      ...
      >
        {map(sendStore.transactionSpeeds, (transactionSpeed: string) => (
          <MenuItem key={transactionSpeed} value={transactionSpeed}>
            <Typography className={classes.fieldTextOrInput}>{chrome.i18n.getMessage('popup_pages_send_'.concat(transactionSpeed.toString()))}</Typography>
          </MenuItem>
        ))}
      </Select>
    </div>
...
const GasLimitField = observer(({ classes, store: { sendStore }, onEnterPress }: any) => (
  <div className={classes.fieldContainer}>
    <div className={classes.buttonFieldHeadingContainer}>
      <div className={classes.buttonFieldHeadingTextContainer}>
        <Heading name={chrome.i18n.getMessage('popup_pages_send_gasLimit')}  />
      </div>
      ...
      >
        {chrome.i18n.getMessage('popup_pages_send_recommended')}
      </Button>
    </div>
    <div className={classes.fieldContentContainer}>
      <TextField
...
const GasPriceField = observer(({ classes, store: { sendStore }, onEnterPress }: any) => (
  <div className={classes.fieldContainer}>
    <div className={classes.buttonFieldHeadingContainer}>
      <div className={classes.buttonFieldHeadingTextContainer}>
        <Heading name={chrome.i18n.getMessage('popup_pages_send_gasPrice')} />
      </div>
...
const SendButton = observer(({ classes, store: { sendStore } }: any) => (
  ...
  >
    {chrome.i18n.getMessage('popup_pages_send_send')}
  </Button>
));
