...
export default class ImportStore {
  ...
  @computed public get walletNameError(): string | undefined {
    return this.walletNameTaken ? chrome.i18n.getMessage('error_walletNameIsTaken') : undefined;
  }
  ...
  @computed public get privateKeyError(): string | undefined {
    if (this.importType === IMPORT_TYPE.PRIVATE_KEY) {
      return isValidPrivateKey(this.mnemonicPrivateKey) ? undefined : chrome.i18n.getMessage('error_notAValidPrivateKey');
    } else {
      return undefined;
    }
  }
