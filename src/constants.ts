...
export enum MESSAGE_TYPE {
  ...
  GET_MAX_SBER_SEND = 'GET_MAX_SBER_SEND',
  GET_MAX_SBER_SEND_RETURN = 'GET_MAX_SBER_SEND_RETURN',
  GET_SBER_USD = 'GET_SBER_USD',
  GET_SBER_USD_RETURN = 'GET_SBER_USD_RETURN',
...
export enum QRYPTO_ACCOUNT_CHANGE {
  ...
  BALANCE_CHANGE = 'Sbercoin.com Account Balance Changed',
