...
/*
* Validates the Sbercoin address based on length and starting character.
* @param isMainNet {boolean} Flag if is a mainnet address (or else testnet address).
* @param address {string} The Sbercoin address to validate.
* @return {boolean} Returns if it is a valid Sbercoin address.
*/
